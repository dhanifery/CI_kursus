  ...
  function __construct()
  {
    ...
    function hapus($id_instr) {
     ...
     function excel()
     {
       ...
       $objPHPExcel->getActiveSheet()->setCellValue('B1','NAMA INSTRUKTUR');
       ...
       foreach ($data['instruktur'] as $ins ) {
         ...
         $objPHPExcel->getActiveSheet()->setCellValue('B',$baris,$ins->username);
         $objPHPExcel->getActiveSheet()->setCellValue('C',$baris,$ins->email_instr);
         $objPHPExcel->getActiveSheet()->setCellValue('D',$baris,$ins->TTL_instr);
         $objPHPExcel->getActiveSheet()->setCellValue('E',$baris,$ins->JK_instr);

         $baris++;
       }

       $filename="Data_instruktur" .date("d-m-y").'.xlsx';
       $objPHPExcel->getActiveSheet()->setTitle("Data Instruktur");
